    ...
    return (
      <div className="account-creation-members">
        ...
        {_.map(approvers, member => {
          const isApproved =
            this.props.account.approved.indexOf(member.pub_key) > -1;
          return (
            <div key={member.id} className="account-member-approval">
        ...
        <div className="approval-percentage">
          <p>
            {approved.length} collected, {approvers.length - approved.length}{" "}
            remaining
