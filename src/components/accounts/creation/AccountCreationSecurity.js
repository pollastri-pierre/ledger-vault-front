  ...
  return (
    <div className="account-creation-security">
      ...
      <div className="security-members">
        <div
          className="security-scheme-line"
        ...
        >
          ...
          <span className="security-scheme-value">
            {account.security.members.length} selected
        ...
        {account.security.members.length === 0 ? (
          ...
          <div
            className={`security-scheme-line ${account.security.approvals >
            account.security.members.length
              ? "error"
              : ""}`}
        ...
        >
          ...
          <span className="security-scheme-value">
            {account.security.timelock.enabled ? (
              <span>
                {account.security.timelock.duration}{" "}
                {account.security.timelock.frequency}
              </span>
            ) : (
              "disabled"
            )}
        ...
        >
          ...
          <span className="security-scheme-value">
            {account.security.ratelimiter.enabled ? (
              <span>
                {account.security.ratelimiter.rate} per{" "}
                {account.security.ratelimiter.frequency}
              </span>
            ) : (
              "disabled"
            )}
