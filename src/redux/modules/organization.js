...
export const GET_ORGANIZATION_APPROVERS_START = 'organization/GET_ORGANIZATION_APPROVERS_START';
export const GOT_ORGANIZATION_APPROVERS = 'organization/GOT_ORGANIZATION_APPROVERS';
export const GOT_ORGANIZATION_APPROVERS_FAIL = 'organization/GOT_ORGANIZATION_APPROVERS_FAIL';
...
export default function reducer(state = initialState, action) {
  switch (action.type) {
    ...
    case GOT_ORGANIZATION_APPROVERS:
      return { ...state, approvers: action.approvers, isLoadingApprovers: false };
