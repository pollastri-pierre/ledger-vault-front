...
describe("AccountCreation module", () => {
  ...
  it("should set modalOpened to true", () => {
    expect(
      reducer(module.initialState, { type: module.OPEN_MODAL_ACCOUNT })
    ).toEqual({
      ...module.initialState,
      modalOpened: true
    });
  ...
  it("should set approvals", () => {
    expect(
      reducer(module.initialState, { type: module.SET_APPROVALS, number: "2" })
    ).toEqual({
      ...module.initialState,
      security: {
        ...module.initialState.security,
  ...
  it("should not set approvals if its not a number", () => {
    expect(
      reducer(module.initialState, { type: module.SET_APPROVALS, number: "aa" })
  ...
  it("should set the internModalId", () => {
    ...
    expect(
      reducer(state, { type: module.SWITCH_INTERN_MODAL, id: "members" })
    ).toEqual({
      ...module.initialState,
  ...
  it("should enable TIMELOCK", () => {
    expect(
      reducer(module.initialState, { type: module.ENABLE_TIMELOCK })
    ).toEqual({
      ...module.initialState,
      security: {
        ...module.initialState.security,
  ...
  it("should enable RATELIMITE", () => {
    expect(
      reducer(module.initialState, { type: module.ENABLE_RATELIMITER })
    ).toEqual({
      ...module.initialState,
      security: {
        ...module.initialState.security,
  ...
  it("shouldnt change timelock frequency and set popBubble to false", () => {
    ...
    expect(
      reducer(state, { type: module.CHANGE_FREQUEMCY_TIMELOCK, frequency: "f" })
    ).toEqual({
      ...module.initialState,
      security: {
        ...module.initialState.security,
  ...
  it("should set the popbubble to true", () => {
    expect(
      reducer(module.initialState, { type: module.OPEN_POPBUBBLE, anchor: "" })
    ).toEqual({
      ...module.initialState,
      popBubble: true
    });
  ...
  it("should close the modal at SAVE_ACCOUNT_START", () => {
    const state = { ...module.initialState, modalOpened: true };
    expect(reducer(state, { type: module.SAVE_ACCOUNT_START })).toEqual(
      module.initialState
    );
  });
  ...
  it("should reset the state at SAVED_ACCOUNT", () => {
    const state = { ...module.initialState, modalOpened: true };
    expect(reducer(state, { type: module.SAVED_ACCOUNT })).toEqual(
      module.initialState
    );
  });
