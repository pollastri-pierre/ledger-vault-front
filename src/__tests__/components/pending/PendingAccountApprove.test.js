...
describe("AccountView container", () => {
  ...
  it("should have a .request-currency ", () => {
    ...
    expect(line.find(".request-currency").text()).toBe(
      props.accounts[0].currency.family
    );
  });
  ...
  it("should have a .request-approval-state", () => {
    ...
    expect(line.find(".request-approval-state").text()).toBe(
      "Collecting Approvals (1/1) "
    );
  });
  ...
  it("should have a ValidateBage if approved", () => {
    ...
    expect(
      line.find(".request-approval-state.approved").find("ValidateBadge").length
    ).toBe(1);
  });
});
